...
@NonNullByDefault
public class SagaThermResponseMessageWriteParam extends SagaThermResponseMessage {

    @Nullable
    protected ParameterIndex parameterIndex;
    protected byte parameterValue;

    public SagaThermResponseMessageWriteParam() {
    ...
    public static SagaThermResponseMessageWriteParam of(byte[] buffer) {
        var message = new SagaThermResponseMessageWriteParam();
